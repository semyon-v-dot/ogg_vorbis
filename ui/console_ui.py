...
def _generate_setup_header(logical_stream, explain_needed: bool) -> str:
    """Generates setup header from input [logical_stream] internal values"""
    return f"""{'-'*8}SETUP HEADER INFO:

Codebooks amount = {len(logical_stream.vorbis_codebook_configurations)}
{'''
FLOORS:
